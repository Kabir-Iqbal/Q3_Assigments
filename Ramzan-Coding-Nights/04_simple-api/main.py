...
#we build two simple get enpoints
# side hustle
# Money Quotes
...
def get_money_quote():
    """Return random money qoute """
    return {"money_qoute": random.choice(money_quotes)}



# for running your project at local host command
# fastapi dev main.py 

# After get url you add /docs then you can see easily your data 
#  like this http://127.0.0.1:8000/docs#/


# and you cal also  see your data directly 
# copy your url and paste on google then put add your endpoint oppf data 
# like this http://127.0.0.1:8000/money_quotes
